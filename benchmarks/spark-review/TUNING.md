...
The selected combined release profile uses MTP2, serial128, readahead2048 and B12x vocabulary, retaining the existing expert tile policy. Readahead2048 also becomes the RTX recipe default without new RTX measurements.
